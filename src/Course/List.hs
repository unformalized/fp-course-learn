...
-- foldRight 可以看作为 constructor replacement
-- List a = a1 :. a2 :. a3 :. a4 :. Nil
-- foldRight f b (List a)
-- :. -> f , Nil -> b
-- a1 `f` a2 `f` a3 `f` a4 `f` b
...
-- List a = a1 :. a2 :. a3 :. a4 :. Nil
-- map f (List a)
-- List b = a1 `f` a2 `f` a3 `f` a4 `f` Nil
...
-- _cons :: a -> Optional a -> Optional a
-- _cons a3 Empty = if f a3 then _rest else Empty
-- _rest :: Optional a
-- x -> Optional (List x) -> Optional (List x)
-- :. :: x -> List x -> List x
